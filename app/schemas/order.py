...
class OrderInfo(BaseModel):
    ...
    status: int = Field(title="订单状态", description="订单状态，0-待支付 1-已支付 2-已取消 3-已完成 4-已退款")
    ...
    refunded_amount: Decimal = Field(default=Decimal("0"), title="已退款金额", description="累计已退款金额")
    created_at: datetime = Field(title="创建时间", description="创建时间")
    updated_at: datetime = Field(title="更新时间", description="更新时间")
